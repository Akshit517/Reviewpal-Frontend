...
abstract class WorkspaceRepositories {
  ...
  Future<Either<Failure, void>> updateCategoryMember(
      String workspaceId, int id, String email, String role);

  /// [Channel] methods
  Future<Either<Failure, Channel>> createChannel(String workspaceId,
      int categoryId, String name, Assignment assignmentData);
  ...
  Future<Either<Failure, List<ChannelMember>>> getChannelMembers(
      String workspaceId, int categoryId, String channelId);
  Future<Either<Failure, ChannelMember>> getChannelMember(
      String workspaceId, int categoryId, String channelId, String email);
  Future<Either<Failure, void>> addMemberToChannel(String workspaceId,
      int categoryId, String channelId, String email, String role, String team);
  Future<Either<Failure, void>> removeMemberFromChannel(
      String workspaceId, int categoryId, String channelId, String email);
  ...
  Future<Either<Failure, void>> updateAssignment(String workspaceId,
      int categoryId, String channelId, Assignment assignment);

  /// [Submission] methods
  Future<Either<Failure, List<Submission>>> getSubmissionReviewees(
      String workspaceId, int categoryId, String channelId);
  Future<Either<Failure, void>> createSubmissionReviewee(String workspaceId,
