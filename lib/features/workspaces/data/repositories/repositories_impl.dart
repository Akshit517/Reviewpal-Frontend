...
class WorkspaceRepositoryImpl implements WorkspaceRepositories {
  ...
  WorkspaceRepositoryImpl(
      {required this.remoteDataSource, required this.userLocalDataSource});
  ...
  Future<Either<Failure, Workspace>> createWorkspace(
    ...
    try {
      final workspaceModel =
          await remoteDataSource.createWorkspace(name: name, icon: icon);
  ...
  Future<Either<Failure, Workspace>> getWorkspace(String workspaceId) async {
    try {
      final workspace =
          await remoteDataSource.getWorkspace(workspaceId: workspaceId);
  ...
  @override
  Future<Either<Failure, void>> addWorkspaceMember(
  ...
  @override
  Future<Either<Failure, void>> removeWorkspaceMember(
  ...
  @override
  Future<Either<Failure, WorkspaceMember>> getWorkspaceMember(
      String workspaceId, String email) async {
    try {
      final member =
          await remoteDataSource.getWorkspaceMember(workspaceId, email);
      return Right(member);
    } catch (e) {
      return Left(_handleException(e));
    }
  ...
  @override
  Future<Either<Failure, void>> updateWorkspaceMember(
  ...
  Future<Either<Failure, void>> deleteCategory(
      String workspaceId, int id) async {
    try {
  ...
  Future<Either<Failure, Category>> updateCategory(
      String workspaceId, int id, String name) async {
    try {
      final category =
          await remoteDataSource.updateCategory(workspaceId, id, name);
      return Right(category);
    } catch (e) {
      return Left(_handleException(e));
    }
  ...
  @override
  Future<Either<Failure, List<CategoryMember>>> getCategoryMembers(
      String workspaceId, int id) async {
    try {
      final members =
          await remoteDataSource.getCategoryMembers(workspaceId, id);
      return Right(members);
    } catch (e) {
      return Left(_handleException(e));
    }
  ...
  @override
  Future<Either<Failure, void>> addMemberToCategory(
      String workspaceId, int id, String email) async {
    try {
  ...
  @override
  Future<Either<Failure, void>> removeMemberFromCategory(
      String workspaceId, int id, String email) async {
    try {
  ...
  @override
  Future<Either<Failure, CategoryMember>> getCategoryMember(
      String workspaceId, int id, String email) async {
    try {
      final member =
          await remoteDataSource.getCategoryMember(workspaceId, id, email);
      return Right(member);
    } catch (e) {
      return Left(_handleException(e));
    }
  ...
  @override
  Future<Either<Failure, void>> updateCategoryMember(
      String workspaceId, int id, String email, String role) async {
    try {
  ...
  Future<Either<Failure, List<Channel>>> getChannels(
      String workspaceId, int categoryId) async {
    try {
      final channels =
          await remoteDataSource.fetchChannels(workspaceId, categoryId);
  ...
  @override
  Future<Either<Failure, Channel>> createChannel(String workspaceId,
      int categoryId, String name, Assignment assignment) async {
    try {
      final channel = await remoteDataSource.createChannel(
          workspaceId, categoryId, name, assignment);
  ...
  @override
  Future<Either<Failure, void>> deleteChannel(
  ...
  Future<Either<Failure, Channel>> updateChannel(
    ...
    try {
      await remoteDataSource.updateAssignment(
          workspaceId, categoryId, channelId, assignment);
      final channel = await remoteDataSource.updateChannel(
          workspaceId, categoryId, channelId, name, assignment);
      return Right(channel);
    } catch (e) {
      return Left(_handleException(e));
    }
  ...
  Future<Either<Failure, List<ChannelMember>>> getChannelMembers(
      String workspaceId, int categoryId, String channelId) async {
    try {
      final members = await remoteDataSource.getChannelMembers(
  ...
  @override
  Future<Either<Failure, ChannelMember>> getChannelMember(String workspaceId,
      int categoryId, String channelId, String email) async {
    try {
      final member = await remoteDataSource.getChannelMember(
          workspaceId, categoryId, channelId, email);
      return Right(member);
    } catch (e) {
      return Left(_handleException(e));
    }
  ...
  @override
  Future<Either<Failure, void>> addMemberToChannel(
      String workspaceId,
      int categoryId,
      String channelId,
      String email,
      ...
      String team) async {
    try {
      await remoteDataSource.addMemberToChannel(
          workspaceId, categoryId, channelId, email, role, team);
      return const Right(null);
    } catch (e) {
      return Left(_handleException(e));
    }
  ...
  @override
  Future<Either<Failure, void>> updateChannelMember(
      String workspaceId,
      int categoryId,
      String channelId,
      String email,
      ...
      String? team) async {
    try {
      await remoteDataSource.updateChannelMember(
          workspaceId, categoryId, channelId, email, role, team);
      return const Right(null);
    } catch (e) {
      return Left(_handleException(e));
  ...
  @override
  Future<Either<Failure, void>> removeMemberFromChannel(String workspaceId,
      int categoryId, String channelId, String email) async {
    try {
      await remoteDataSource.removeMemberFromChannel(
          workspaceId, categoryId, channelId, email);
      return const Right(null);
    } catch (e) {
      return Left(_handleException(e));
  ...
  Future<Either<Failure, Assignment>> getAssignment(
      String workspaceId, int categoryId, String channelId) async {
    try {
      final assignment = await remoteDataSource.getAssignment(
          workspaceId, categoryId, channelId);
  ...
  @override
  Future<Either<Failure, void>> updateAssignment(String workspaceId,
      int categoryId, String channelId, Assignment assignment) async {
    try {
      await remoteDataSource.updateAssignment(
          workspaceId, categoryId, channelId, assignment);
      return const Right(null);
  ...
  Future<Either<Failure, List<Submission>>> getSubmissionReviewees(
      String workspaceId, int categoryId, String channelId) async {
    try {
      final submissions = await remoteDataSource.getSubmissionReviewees(
          workspaceId, categoryId, channelId);
  ...
  @override
  Future<Either<Failure, List<Submission>>> createSubmissionReviewee(
      String workspaceId,
      int categoryId,
      String channelId,
      String? content,
      String? file) async {
    try {
      final submissions = await remoteDataSource.postSubmissionReviewee(
          workspaceId, categoryId, channelId, content, file);
      return Right(submissions);
    } catch (e) {
      return Left(_handleException(e));
    }
  ...
  @override
  Future<Either<Failure, List<Submission>>> getSubmissionByTeamId(
      String workspaceId,
      int categoryId,
      String channelId,
      String teamId) async {
    try {
      final submissions = await remoteDataSource.getSubmissionByTeamId(
          workspaceId, categoryId, channelId, teamId);
      return Right(submissions);
    } catch (e) {
      return Left(_handleException(e));
    }
  ...
  Future<Either<Failure, ReviewIteration>> getReviewerIteration(
    ...
    try {
      final iteration = await remoteDataSource.getReviewerIteration(
          workspaceId, categoryId, channelId, submissionId);
  ...
  Future<Either<Failure, ReviewIteration>> createIteration(
      ...
      int submissionId,
      String remarks,
      AssignmentStatus? assignmentStatus) async {
    try {
      ReviewIteration create = await remoteDataSource.createIteration(
          workspaceId,
          categoryId,
          channelId,
          submissionId,
  ...
  Future<Either<Failure, RevieweeIterationsResponse>> getRevieweeIterations(
      ...
      int submissionId) async {
    try {
      RevieweeIterationsResponse create =
          await remoteDataSource.getRevieweeIterations(
              workspaceId, categoryId, channelId, submissionId);
      return Right(create);
    } catch (e) {
      return Left(_handleException(e));
